 ...
 * {@link UserNameDialog.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link UserNameDialog#newInstance} factory method to
...
public class UserNameDialog extends DialogFragment implements View.OnClickListener {
     ...
     * @return A new instance of fragment UserNameDialog.
     */
    // TODO: Rename and change types and number of parameters
    public static UserNameDialog newInstance(String param1, String param2) {
...
/*        if (context instanceof OnFragmentInteractionListener) {
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.save_btn){
            sharedPref.setUserName(user_name.getText().toString());
            dismiss();
        }
    }
